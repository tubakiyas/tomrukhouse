            ...
            <div class="row align-items-end">
                <div class="col-xl-12 col-lg-6 col-md-7">
                    <div class="skill-content-wrap">
                        ...
                        <p>
                            1. Tanımlar <br>
                            Bu Gizlilik Sözleşmesi, [Şirket Adı] tarafından sağlanan hizmetler ile kullanıcıların kişisel bilgilerini koruma amacını taşımaktadır.<br>
                            ...
                            7. Değişiklikler<br>
                            Bu Gizlilik Sözleşmesi, gerektiğinde güncellenebilir. Değişiklikler hakkında bilgilendirme yapılacak ve güncel sözleşme web sitemizde yayınlanacaktır.<br>
